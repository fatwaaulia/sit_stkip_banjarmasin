...
class RencanaPenetapanKeuangan extends BaseController
{
    protected $base_name;
    ...
    {
        $this->base_name   = 'rencana_penetapan_keuangan';
    ...
    public function index()
    {
        ...
        if (array_intersect(userSession('id_roles'), [8, 3, 9])) {
            $base_query->where('kategori', 'SK PENETAPAN');
        } elseif (in_array(2, userSession('id_roles')) && !in_array(18, userSession('id_roles'))) {
            $base_query->where('kategori', 'SK PENETAPAN');
        }
