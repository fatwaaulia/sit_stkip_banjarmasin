...
class PermintaanLegalisir extends BaseController
{
    protected $base_name;
    ...
    {
        $this->base_name   = 'permintaan_legalisir';
    ...
    public function create()
    {
        ...
        return $this->response->setStatusCode(200)->setJSON([
            ...
            'route'   => base_url() . 'permintaan-legalisir/detail?email=' . $this->request->getVar('email'),
        ]);
    }
