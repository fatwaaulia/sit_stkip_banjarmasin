        ...
        <div class="col-12">
            <div class="card p-3">
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-12 col-md-6 col-lg-7 col-xxl-8 d-flex justify-content-end align-items-end">
                ...
                <form id="form_${data.id}">
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="jenis" class="form-label">Jenis</label>
                            <select class="form-select" id="jenis" name="jenis">
                                ${jenis.map(item => `<option value="${item}" ${item == data.jenis ? 'selected' : ''}>${item}</option>` )}
                            </select>
                            <div class="invalid-feedback" id="invalid_jenis"></div>
                        </div>
                        <div class="mb-3">
