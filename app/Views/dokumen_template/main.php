<?php
$is_access = false;
if (array_intersect(userSession('id_roles'), [1, 17, 9])) {
    $is_access = true;
}
?>
                                            ...
                                            <div class="mb-3">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="kategori" name="kategori">
                                                        ...
                                                        <?php
                                                        $kategori = ['SELURUH DOSEN', 'STRUKTURAL'];
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="sub_judul" name="sub_judul">
                                                        ...
                                                        <?php
                                                        $singkatan_program_studi = model('ProgramStudi')->findColumn('singkatan');
                                                        foreach ($singkatan_program_studi as $v) :
                                                        ?>
                                                        <option value="<?= $v ?>"><?= $v ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                    <div class="invalid-feedback" id="invalid_sub_judul"></div>
                                                </div>
                                                <div class="mb-3">
...
function renderOpsi(data) {
    const kategori = ['SELURUH DOSEN', 'STRUKTURAL'];
    const singkatan_program_studi = JSON.parse(`<?= json_encode($singkatan_program_studi) ?>`);
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="sub_judul" name="sub_judul">
                                <option value="">Pilih</option>
                                <option value="Sekolah Tinggi">Sekolah Tinggi</option>
                                ${singkatan_program_studi.map(item => `<option value="${item}" ${item == data.sub_judul ? 'selected' : ''}>${item}</option>`).join('')}
                            </select>
                            <div class="invalid-feedback" id="invalid_sub_judul"></div>
                        </div>
                        <div class="mb-3">
