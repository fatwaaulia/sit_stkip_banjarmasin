...
<div class="container-fluid">
    <div class="row mb-3 mt-4">
        <div class="col-12">
            <a href="<?= base_url(userSession('slug_role')) ?>/keuangan/new/uang-masuk" class="btn btn-success me-2">
                <i class="fa-solid fa-arrow-down fa-sm"></i> Uang Masuk
            </a>
            <a href="<?= base_url(userSession('slug_role')) ?>/keuangan/new/uang-keluar" class="btn btn-danger">
