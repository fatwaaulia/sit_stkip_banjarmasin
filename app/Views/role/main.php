                                    ...
                                    <form id="form">
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                ...
                                                <div class="invalid-feedback" id="invalid_id"></div>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="invalid-feedback" id="invalid_slug"></div>
                                            </div>
                                        </div>
            ...
            <div class="modal-content">
                ...
                <form id="form_${data.id}">
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="id" class="form-label">ID</label>
                            <input type="number" class="form-control" id="id" name="id" value="${data.id}" placeholder="Masukkan id">
                            <div class="invalid-feedback" id="invalid_id"></div>
                        </div>
                        <div class="mb-3">
                            <label for="nama" class="form-label">Nama</label>
                        ...
                        <div class="mb-3">
                            <label for="slug" class="form-label">Slug</label>
                            <input type="text" class="form-control" id="slug" name="slug" value="${data.slug}" placeholder="Masukkan slug">
                            <div class="invalid-feedback" id="invalid_slug"></div>
                        </div>
                    </div>
                    <div class="modal-footer">
